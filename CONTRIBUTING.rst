...
heamy could always use more documentation, whether as part of the
official heamy docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 2.7 and 3.5. Check
   https://travis-ci.org/rushter/heamy/pull_requests
